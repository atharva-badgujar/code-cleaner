...
echo "  clean system          Clean npm cache 🆕"
echo ""
echo "Features:"
echo "  ✨ Remove AI comments from code"
echo "  📝 Add documentation to code"
echo "  🎨 Format code professionally"
echo "  🧹 Smart npm cache cleaning (NEW!)"
